...
class DexBot(commands.Bot):
    ...
    # rest of the functions that were previously in main.py but looked ugly
    # i cant express how much I implore you to switch to aiosqlite while you still can
